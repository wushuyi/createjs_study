...
// symbols:
	...
	(lib.Tween2 = function(mode,startPosition,loop) {
		...
		this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance}]},120).to({state:[{t:this.instance_1}]},2).wait(9));
		...
		this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(118).to({_off:false},0).to({_off:true},2).wait(11));
		...
		this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(116).to({_off:false},0).to({_off:true},2).wait(13));
		...
		this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(58).to({graphics:mask_graphics_58,x:149.8,y:-566.9}).wait(30).to({graphics:null,x:0,y:0}).wait(43));
		...
		this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_5}]}).to({state:[{t:this.instance_6}]},35).to({state:[{t:this.instance_6}]},4).to({state:[{t:this.instance_6}]},9).to({state:[{t:this.instance_6}]},8).to({state:[]},2).wait(73));
		this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(35).to({_off:false},0).to({rotation:-37.2,x:-134.1,y:-422.7},4).to({x:-148.1,y:-438.7},9).to({x:-154.7,y:-452.7,alpha:0},8).to({_off:true},2).wait(73));
		...
		this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:mask_1_graphics_0,x:-59.9,y:42.6}).wait(36).to({graphics:null,x:0,y:0}).wait(95));
	...
	(lib.Symbol1 = function(mode,startPosition,loop) {
		...
		this.timeline.addTween(cjs.Tween.get(this.instance).to({x:312.1,alpha:1},18).wait(42).to({startPosition:0},0).to({alpha:0},15).to({_off:true},1).wait(58));
		...
		this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(15).to({_off:false},0).to({x:314.1,alpha:1},18).wait(27).to({startPosition:0},0).to({alpha:0},15).to({_off:true},1).wait(58));
		...
		this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_2}]},35).to({state:[]},1).to({state:[{t:this.instance_3}]},86).to({state:[]},1).wait(11));

		// Layer 10
		this.instance_4 = new lib.Symbol5("synched",0,false);
		this.instance_4.setTransform(370.4,377.6,0.833,0.833,0,0,0,393.5,401.3);

		this.timeline.addTween(cjs.Tween.get(this.instance_4).to({_off:true},35).wait(99));
		...
		this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(124).to({_off:false},0).to({scaleX:1.05,scaleY:1.05,x:331.5,y:419.2,alpha:1},4,cjs.Ease.get(1)).to({scaleX:1,scaleY:1,x:330.5,y:412.6},3).wait(3));
		...
		this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(87).to({_off:false},0).to({alpha:1},21).wait(26));

		// pro.png
		this.instance_7 = new lib.Tween2("synched",0);
		this.instance_7.setTransform(440.7,812.1);

		this.timeline.addTween(cjs.Tween.get(this.instance_7).to({x:360.7,startPosition:35,loop:false},35,cjs.Ease.get(1)).wait(99));

		// bg2.jpg
		this.instance_8 = new lib.Tween1("synched",0);
		this.instance_8.setTransform(336.5,568);

		this.timeline.addTween(cjs.Tween.get(this.instance_8).to({x:276.5},35,cjs.Ease.get(1)).wait(99));
