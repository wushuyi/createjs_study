...
// symbols:
	...
	(lib.Tween16 = function() {
		...
		this.instance.setTransform(-140.5,-17.5);

		this.addChild(this.instance);
	}).prototype = p = new cjs.Container();
	p.nominalBounds = new cjs.Rectangle(-117,-14.5,234,29);
	...
	(lib.Tween15 = function() {
		...
		this.instance.setTransform(-138,-20);

		this.addChild(this.instance);
	}).prototype = p = new cjs.Container();
	p.nominalBounds = new cjs.Rectangle(-50.5,-14,101,28);
	...
	(lib.Symbol1 = function(mode,startPosition,loop) {
		...
		this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(120).to({_off:false},0).to({scaleX:1.05,scaleY:1.05,x:331.5,y:419.2,alpha:1},4,cjs.Ease.get(1)).to({scaleX:1,scaleY:1,x:330.5,y:412.6},3).wait(7));
